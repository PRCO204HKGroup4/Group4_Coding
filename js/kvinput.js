!function(e) {
	...
	t = {
					...
					sendAjax: function(e, a, n) {
						...
						if (!s.chunksProcessed[u] || !s.chunksProcessed[u][e]) {
							...
							m = new FormData, o = l.stack[u], i._setUploadData(m, {
								...
								fileSize: p.size,
								retryCount: a
							}), s.$progress && s.$progress.length && s.$progress.show(), v = function(r) {
		...
		_initTemplateDefaults: function() {
			var i, a, r, n, o, l, s, d, c, u, p, f, g, m, h, v, w, b, _, C, y, x, T, P, k, E, F, S, I, A, D, z, M, j, U, $, R, O, B, L, Z, N = this;
		...
		_zoomSlideShow: function(t, i) {
			var a, r, n, o, l = this,
				...
				u = d.length;
			if (!s.attr("disabled")) {
				for (r = 0; u > r; r++) n = e(d[r]), n && n.length && n.find(".kv-file-zoom:invisible").length && c.push(d[r]);
		...
		_initUploadSuccess: function(i, a, r) {
			...
			return !m.showPreview || "object" != typeof i || e.isEmptyObject(i) ? void m._resetCaption() : (void 0 !== i.initialPreview && i.initialPreview.length > 0 && (m.hasInitData = !0, c = i.initialPreview || [], u = i.initialPreviewConfig || [], p = i.initialPreviewThumbTags || [], n = void 0 === i.append || i.append, c.length > 0 && !t.isArray(c) && (c = c.split(m.initialPreviewDelimiter)), c.length && (m._mergeArray("initialPreview", c), m._mergeArray("initialPreviewConfig", u), m._mergeArray("initialPreviewThumbTags", p)), void 0 !== a ? r ? (f = a.attr("id"), g = m._getUploadCacheIndex(f), null !== g && (m.uploadCache[g] = {
				...
				tags: p[0] || [],
				append: n
			})) : (l = m.previewCache.add(c[0], u[0], p[0], n), o = m.previewCache.get(l, !1), s = t.createElement(o).hide().insertAfter(a), d = s.find(".kv-zoom-cache"), d && d.length && d.insertAfter(a), a.fadeOut("slow", function() {
		...
		_initPreviewActions: function() {
			...
			i._initZoomButton(), a.find(n).each(function() {
				...
				if (!t.isEmpty(p) && void 0 !== f) {
					...
					y = parseInt(y.replace(t.INIT_FLAG, "")), v = t.isEmpty(C.config) && t.isEmpty(C.config[y]) ? null : C.config[y], b = t.isEmpty(v) || t.isEmpty(v.extra) ? r : v.extra, w = v.filename || v.caption || "", "function" == typeof b && (b = b()), h = {
						id: u.attr("id"),
						key: f,
						extra: b
					}, n = function(e) {
		...
		_generatePreviewTemplate: function(i, a, r, n, o, l, s, d, c, u, p, f, g, m) {
			...
			}, p = p || o.slice(o.lastIndexOf("-") + 1), b.fileActionSettings.showZoom && (C = w(S ? "other" : i, m ? m : a, !0, "kv-zoom-thumb")), C = "\n" + b._getLayoutTemplate("zoomCache").replace("{zoomContent}", C), "function" == typeof b.sanitizeZoomCache && (C = b.sanitizeZoomCache(C)), h = w(F ? "other" : i, a, !1, "kv-preview-thumb"), h + C
		},
		...
		readFiles: function(i) {
			...
			var a, r = this,
				...
				v = function(t, n, o, l, s, d) {
					var c, p = e.extend(!0, {}, r._getOutData(null, {}, {}, i), {
						id: o,
						index: l,
						fileId: s
					}),
			...
			r.fileManager.clearImages(), e.each(i, function(e, t) {
				...
				r.lock(!0);
				var y, x, T, P, k, E, F, S, I, A, D, z, M, j, U = i[w],
					$ = c + "-" + r._getFileId(U),
					R = p.text,
					O = p.image,
					B = p.html,
	...
	e.fn.fileinput.defaults = {
		...
		fileSingle: "file",
		filePlural: "files",
		browseLabel: "<span class='fa fa-folder-open' style='margin-top:8px'>新增附件</span>",
		removeLabel: "移除附件",
		...
		msgFilesTooMany: "請注意，已超出了相片上限<b>{m}</b>張的限制!",
